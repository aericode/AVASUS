...
import { Container, CoursePartners, CourseTitle, InfoText, InfoWrapper, ResponsivityWrapper, SeeModuleButton, SeeModuleText, TextWrapper, Thumbnail, Wrapper } from "./styles";
